...
function register ($data) {
    ...
    $passwordConf = mysqli_real_escape_string ($db, $data["passwordConf"]);

    // cek username sudah terdaftar atau belum di database
    ...
    // cek kesesuaian password dengan password conf
